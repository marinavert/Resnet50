...
# Load state dict 
state_dict = torch.load('/home/ubuntu/local/Resnet50/models/weighted/verb_split'+str(split)+'.pt')
...
annots_val = pd.read_csv("/home/ubuntu/local/Resnet50/csv/verb/split"+str(split)+"/test.csv")
...
results.to_csv('/home/ubuntu/local/Resnet50/results/weighted/verb/V_split'+str(split)+'.csv')
